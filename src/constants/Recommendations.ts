...
export const Recommendations: IRecommendation[] = [
  {
    ...
    company: "Webedia",
    person: "Igor Uzelac",
    designation: "Project Manager at Act Digital Serbia",
    created: "January 2024",
    related: "January 10, 2025, Igor managed Goran directly",
    description:
      `
I had the privilege of working alongside Goran at Act Digital Serbia for almost 3 years now. During this time, I was consistently impressed by his technical expertise, work ethic, and collaborative spirit.<paragraph>
Goran has an exceptional ability to design and implement efficient, scalable, and robust backend solutions. He is proficient in PHP, Laravel, Symfony, MySQL and have demonstrated a deep understanding of web development best practices. Goran played a pivotal role in optimising database performance, implementing secure APIs and integrating third-party services.<paragraph>
Beyond technical skills, Goran is a fantastic team player. His consistently contributed to a positive work environment by collaborating effectively with cross-functional teams, providing constructive feedback. His ability to handle tight deadlines and solve complex problems under pressure was invaluable to our team.<paragraph>
Therefore, I am confident that Goran will be a tremendous asset to any team !
    `,
  },
  {
    icon: FaJoomla,
    ...
    description:
      `
I've had the privilege of working with Goran for several years, and his impact on our backend development team has been tremendous. Goran played a key role in building and maintaining the backend for our high-traffic publishing platform, ensuring it stayed reliable and fast even under heavy audience loads.<paragraph>
His technical expertise and attention to detail have been critical to our success. Beyond their skills, Goran is a team player who's always ready to tackle tough challenges and share knowledge with others. Any team would be lucky to have him!<paragraph>
    `,
  },
  {
    icon: FaPhp,
